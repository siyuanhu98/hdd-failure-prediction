...
# import random
import argparse
from utils.loadDataTH import read_data
...
def parse_args():
    ...
    parser.add_argument("--xpath", help="Xdata Path", default='whole_x_sample.npy', type=str,  required=True)
    parser.add_argument("--ypath", help="ydata Path", default='whole_y_sample.npy', type=str, required=True)
    parser.add_argument("--group", help="group", default='S', type=str, required=True)
